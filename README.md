...
```bash
pi@pPro18 ~/code/2020/Nick-LeafSheets/github/leafsheets-django (update-lambda)
...
table.sh:29:AWS_STORAGE_BUCKET_NAME         :no_entry:️              :no_entry:️              :white_check_mark:              :no_entry:️   # needed in magic.sh (to create bucket), and leafsheets/models.py (to process .docx -> .pdf)
pi@pPro18 ~/code/2020/Nick-LeafSheets/github/leafsheets-django (update-lambda)
